...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> INFESTED_STONE_PLACED = PLACED_FEATURES.register("infested_stone_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.INFESTED_STONE.getHolder().get(),
                    commonOrePlacement(5, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(80)))));

    public static final RegistryObject<PlacedFeature> SAND_PLACED = PLACED_FEATURES.register("sand_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.SAND.getHolder().get(),
                    commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(80)))));

    public static final RegistryObject<PlacedFeature> SANDSTONE_PLACED = PLACED_FEATURES.register("sandstone_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.SANDSTONE.getHolder().get(),
                    commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(80)))));

    public static final RegistryObject<PlacedFeature> DEEPSLATE_PLACED = PLACED_FEATURES.register("deepslate_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.DEEPSLATE.getHolder().get(),
                    commonOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(20)))));

    public static final RegistryObject<PlacedFeature> COBBLED_DEEPSLATE_PLACED = PLACED_FEATURES.register("cobbled_deepslate_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.COBBLED_DEEPSLATE.getHolder().get(),
                    commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(-60), VerticalAnchor.absolute(0)))));

    public static final RegistryObject<PlacedFeature> STONE_PLACED = PLACED_FEATURES.register("stone_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.STONE.getHolder().get(),
                    commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.absolute(0)))));
