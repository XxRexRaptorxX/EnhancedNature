...
public class ModBlocks {
    ...
    public static final DeferredBlock<BlockQuicksand> QUICK_SAND = registerBlock("quicksand",
            properties -> new BlockQuicksand(properties.strength(0.65F, 0.0F).sound(SoundType.SAND).mapColor(MapColor.SAND).noOcclusion().instrument(NoteBlockInstrument.SNARE)));
